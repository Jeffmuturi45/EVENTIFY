...
class Payment(models.Model):
    ...
    callback_data = models.JSONField(null=True, blank=True)  # Store full callback data
    ...
    def check_mpesa_status(self):
        """Check actual M-Pesa transaction status"""
        ...
        mpesa = MpesaGateway()
        response, error = mpesa.check_transaction_status(self.checkout_request_id)
        ...
        if response:
            ...
            self.save()
            return self.status, response.get('ResultDesc', 'Status checked')
